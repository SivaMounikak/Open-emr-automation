...
formatter.step({
  "name": "I  enter details and click on create new patient and confirm new patient",
  "keyword": "When "
});
formatter.match({
  "location": "com.cts.stepdefinations.StepDefinations.i_enter_details_and_click_on_create_new_patient_and_confirm_new_patient()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "I should access to the dashboard portal",
  "keyword": "Then "
});
formatter.match({
  "location": "com.cts.stepdefinations.StepDefinations.i_should_access_to_the_dashboard_portal()"
});
formatter.result({
  "status": "passed"
});
